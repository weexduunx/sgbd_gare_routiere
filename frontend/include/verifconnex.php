...
if(isset($_SESSION['niveau_dacces']) && $_SESSION['niveau_dacces']=="Admin"){
    header("Location: {$home_url}backend/index.php?action=logged_in_as_admin");
}
...
// Si c'est la page "Connexion" ou "Inscrivez-vous" ou "Inscription", mais le client était déjà connecté
else if(isset($page_title) && ($page_title=="Connexion" || $page_title=="Inscription")){
    // Si l'utilisateur n'est pas encore connecté, rediriger vers la page de connexion
