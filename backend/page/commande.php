            ...
            <div class="mdc-card ">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="btn-group mb-3" >
                        <label  id="nouveau" class="btn btn-outline-success" data-toggle="modal" data-target="#createModal"> Ajouter
                ...
                <!-- include -->
                <?php include_once 'comTable.php';?>
                <?php include('comCrud/modal.php'); ?>
