    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <input type="hidden" class="id_assurance" name="id_assurance" id="id_assurance">
              <div class="row">
                <div class="form-group col-md-12">
                    <div class="input-group mb-3">
                      <label class="input-group-text" for="inputGroupSelect01">
                      ...
                      <input class="form-control" id="membre" name="membre"  >
              ...
              <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" id="assurancetype" name="assurancetype" >
                    </div>
                </div>
                <div class="form-group col-md-6">
                    <label for="recipient-name" class="col-form-label">Montant Assurance:</label>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary" id="modifier" name="modifier">Envoyer</button>
          </div>
        </form>
      </div>
    </div>
