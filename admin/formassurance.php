...
<div class="modal fade" id="assuranceModal" tabindex="-1" role="dialog" aria-labelledby="userModalLabel1"
  aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="ajoutform" method="POST" enctype="multipart/form-data">
